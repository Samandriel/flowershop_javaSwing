...
public class Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fieldOfConfirmPassword = new javax.swing.JPasswordField();
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(fieldOfConfirmPassword))
                            .addComponent(fieldOfPassword, javax.swing.GroupLayout.Alignment.TRAILING))))
                .addGap(57, 57, 57))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel7)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(fieldOfConfirmPassword, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(35, 35, 35)
    ...
    private void submit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submit1ActionPerformed
        try {                                        
            ...
            char[] pass = fieldOfPassword.getPassword();
            char[] confirmPass = fieldOfConfirmPassword.getPassword();
            
            if (!Arrays.equals(pass, confirmPass)) {
                JOptionPane.showMessageDialog(null, "Password not Match");               
            } else {
                if (this.id == 0) {
                    data.create(fieldOfName.getText(), fieldOfEmail.getText(), fieldOfPhone.getText(), String.valueOf(pass));
                } else {
                    data.update(this.id, fieldOfName.getText(), fieldOfEmail.getText(), fieldOfPhone.getText(), String.valueOf(pass));
                }
    ...
    private javax.swing.JPasswordField fieldOfConfirmPassword;
